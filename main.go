...
func parseFile(filename string) []sliceInfo {
...
func main() {
	var filename string
	flag.StringVar(&filename, "name", "", "Name of the slice to create a collection methods to")
	flag.Parse()

	slices := parseFile(filename)
...
var t = template.Must(template.New("collection").Parse(collection))


// @todo add map to
// @todo move template to file
var collection = `// generated by collections; DO NOT EDIT
